		...
		<tbody>
			<c:forEach items="${list_accounts}" var="acc">
				...
				<tr class="timeline-badge danger"></c:if> 
					<td><a href="${pageContext.request.contextPath}/admin/accounts3step.html?acc1=${acc1}&acc2=${acc.account}">${acc.account }</a></td>
					<td>${acc.money }</td>
...
<spring:form modelAttribute="transfer" id="form" action="addTransfer.html">
	<div class="row">
